...
class ImportProgram2 extends Command
{
    const OFF_SET = 0;
    const LIMIT = 200;
     ...
     * @var string
     */
    protected $signature = 'importProgram2:cron';
            ...
            if (false && $zoho_programs['data']['info']['more_records']) {
                ...
                if(count($this->data['insert']) > 0){
                    foreach ($this->data['insert'] as $zoho_program) {
                        ...
                        //(new Program())->savePrestaShopProduct($zoho_program);
                    }
                }
