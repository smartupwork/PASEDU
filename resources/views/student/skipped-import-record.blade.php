...
@section('content')
    ...
    <div class="section__content">
        <div class="container-fluid">
            <h2 class="page-titel m-b-20">Student Skipped Record</h2>
                                ...
                                @foreach($skipped_records as $skipped_record)
                                    ...
                                    @php
                                        ...
                                        if($list_type == 'skipped'){
                                            $error_html = implode('<br>', $skipped_record['errors']);
                                        }else if($list_type == 'warning' && $skipped_record['errors']){
                                            foreach ($skipped_record['errors'] as $column => $error) {
