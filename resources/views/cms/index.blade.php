    ...
    <div class="section__content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">We Templates</div>
                        <div class="card-body card-block m-3 psp-temp">
                            ...
                            <div class="mx-auto col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <a href="{{route('course-marketing')}}" class="text-center">
                                            <img src="/images/mr-1.jpeg" alt="">
                                            <p>Course Marketing</p>
                                        </a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="{{route('funding-sources')}}" class="text-center">
                                            <img src="/images/mr-2.jpeg" alt="">
                                            <p>Funding Sources</p>
                                        </a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="{{route('social-media')}}" class="text-center">
