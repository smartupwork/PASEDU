@include('layout.dashboard.head')
            ...
            <div class="main-content">
                <div class="section__content">
                    <div class="container-fluid">
                        <h2 class="page-titel m-b-20">System Email Logs</h2>
                        <div class="row adv-search-row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control py-2 border-right-0 border" onkeyup="loadData(true, true);" type="text" id="q" name="q">
            ...
            <div class="modal fade" id="ColumnSetting" tabindex="-1" role="dialog" aria-labelledby="ColumnSettingLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form name="frmid" id="frmid" action="{{ route('leads-view-header-update') }}" method="post">
                        <input type="hidden" name="module" value="email_logs">
                        {{ csrf_field() }}
    ...
    <script> 
        ...
        function loadData(reset_limit, delay){
            var loader = '<tr id="table-loader"><td colspan="5"><img src="{{$_ENV['S3_CONTENT_PATH']}}dashboard/images/icon/loader.gif"></td></tr>';
            $('#table-loader').remove();
            ...
            timer = setTimeout(function() {
                ...
                currentRequestSer =
                    $.ajax({
                        type: "GET",
                        url: "{{route('system-email-logs-ajax')}}",
                        //dataType : 'json',
                        cache: true,
                        data: {
                            q: $('#q').val(),
