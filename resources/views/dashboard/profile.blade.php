                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form name="frmname" id="frmid" action="{{ route('profilesubmit')}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select disabled="" name="partner" id="partner" class="form-control">
                                                                <option value="">Please select</option>
                                                                <option @if($memdata->partner == 'Not Applicable') selected="selected" @endif value="Not Applicable">Not Applicable</option>
                                                                @if(count($partners) > 0)
