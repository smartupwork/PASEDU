@include('layout.dashboard.head')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row adv-search-row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control py-2 border-right-0 border" type="text" name="q" onkeyup="loadcommandfun();" placeholder="Search" id="q">
                            ...
                            <div class="col-md-7 text-right pt-3 pb-2">
                                ...
                                <a href="/dashboard/myusers/add" class="btn btn-primary btn-sm">
            ...
            <div class="modal fade" id="ColumnSetting" tabindex="-1" role="dialog" aria-labelledby="ColumnSettingLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form name="frmid" id="frmid" action="{{ route('leads-view-header-update') }}" method="post">
                        <input type="hidden" name="module" value="my_users">
                        {{ csrf_field() }}
    ...
    <script> 
        ...
        function exporttopdf(){
            var q = $("#q").val();
            window.location.href = '/dashboard/myusers/exportpdf?q='+q+'&fname='+$("#fname").val()+'&lname='+$("#lname").val()+'&role='+$("#role").val()+'&status='+$("#status").val()+'&email='+$("#email").val()+'&phone='+$("#phone").val();
        }
        function exporttoexcel(){
            var q = $("#q").val();
            window.location.href = '/dashboard/myusers/exportexcel?q='+q+'&fname='+$("#fname").val()+'&lname='+$("#lname").val()+'&role='+$("#role").val()+'&status='+$("#status").val()+'&email='+$("#email").val()+'&phone='+$("#phone").val();
        }
