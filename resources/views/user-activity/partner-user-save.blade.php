...
<div class="table-responsive m-b-20">
    <table style="widtd:100%" class="table table-earning data-table">
        ...
        <tr>
            ...
            <td>{{ \Illuminate\Support\Facades\DB::table('pas_partner')->where('id', '=', $data['new_data']['partner_id'])->value('partner_name') }}</td>
        </tr>
        <tr>
            <td><strong>Partner Type</strong></td>
            <td>{{ \Illuminate\Support\Facades\DB::table('pas_partner_type')->where('id', '=', $data['new_data']['partner_type'])->value('partner_type') }}</td>
        </tr>
    </table>
</div>
