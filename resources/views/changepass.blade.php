   ...
   <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-4 pas-login">
            <form name="frmname" method="post" id="frmid" action="{{route('changepassword')}}" class="form-signin" autocomplete="off">
              {{ csrf_field()}}
            <div class="text-center mb-4">
              <img class="img-fluid" src="{{$CDN_URL}}images/logo.png" alt="" width="200" />
            </div>
              <div class="form-label-group">
                <input type="text" maxlength="6" id="otp" name="otp"   placeholder="OTP Code" class="form-control" autofocus tabindex="1">
            </div>
            <div class="form-label-group">
                <input maxlength="16" type="password" id="pass" name="pass"   placeholder="New Password" class="form-control input-password" tabindex="2">
            ...
            <div class="form-label-group">
                <input maxlength="16" type="password" id="cpass" name="cpass"  placeholder="Confirm Password" class="form-control input-password" tabindex="3">
             <button id="toggle-cpass" type="button" class="" aria-label="Show password as plain text. Warning: this will display your password on the screen.">
              ...
              <button name="btnAdd" id="btnAdd" type="submit" class="form-signin_submit">Reset Password</button>
