                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form name="myUserForm" id="myUserForm" method="post" action="{{ route('users-store')}}"  enctype="multipart/form-data">
                                    {{ csrf_field()}}
                                    @if($edata)
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="roleid" id="roleid" class="form-control">
                                                        ...
                                                        <option @if($edata->roleid == '1') echo {{'selected="selected"'}} @endif  value="1">Account Manager</option>
                                                        <option @if($edata->roleid == '2') echo {{'selected="selected"'}} @endif value="2">Account Support</option>
                                                        <option @if($edata->roleid == '3') echo {{'selected="selected"'}} @endif value="3">Registration Account</option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="form-group" id="showpartnettype">
                                                        <div class="form-check-inline form-check">
                                                            <label for="inline-radio1" class="form-check-label ">
                                                                <input type="radio" id="augusoft_campus" name="augusoft_campus" @if($edata->augusoft_campus == '1') echo {{'checked="checked"'}} @endif value="1" class="form-check-input">Augusoft
                                                            </label>
                                                            <label for="inline-radio2" class="form-check-label ">
                                                                <input type="radio" id="augusoft_campus1" name="augusoft_campus" @if($edata->augusoft_campus == '2') echo {{'checked="checked"'}} @endif value="2" class="form-check-input">Campus CE
                                                            </label>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status" class="form-control">
                                                        <option @if($edata->status == '1') echo {{'selected="selected"'}} @endif value="1">Active</option>
                                                        <option @if($edata->status == '2') echo {{'selected="selected"'}} @endif value="2">Locked</option>
                                                    </select>
                                                </div>
