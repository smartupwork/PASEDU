<?php echo $__env->make('layout.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-4 pas-login">
            ...
            <form method="post" action="<?php echo e(route('submit')); ?>" name="frmid" id="frmid" class="form-signin">
                <?php echo e(csrf_field()); ?>

            <div class="text-center mb-4">
              <img class="img-fluid" src="<?php echo e($CDN_URL); ?>images/logo.png" alt="" width="200" />
            ...
            <div class="form-label-group">
                <input type="text" id="email" name="email" maxlength="118" class="form-control"  placeholder="Email address" autofocus value="<?php if(isset($_COOKIE['email'])): ?><?php echo e(base64_decode($_COOKIE['email'])); ?><?php endif; ?>">
            </div>
            ...
            <div class="checkbox mb-3">
              <label class="px-2">
                <input type="checkbox" value="1" name="remember" id="remember" <?php echo e(isset($_COOKIE['email']) ? 'checked' : ''); ?>> <?php echo e(__('Remember Me')); ?>
  ...
  <script src="<?php echo e($CDN_URL); ?>js/jquery.min.js"></script>
  <script src="<?php echo e($CDN_URL); ?>js/show-password-toggle.min.js"></script>
  <script src="<?php echo e($CDN_URL); ?>js/jquery.form.js"></script>
<script src="<?php echo e($CDN_URL); ?>js/bootstrap.min.js"></script>
  <script>
      $('#frmid').ajaxForm({
...
<?php /**PATH C:\xampp\htdocs\pasedu\resources\views/index.blade.php ENDPATH**/ ?>